...
public class CastDiscoveryProvider implements DiscoveryProvider {
    ...
    public void start() {
        ...
        if (mMediaRouteSelector == null) {
            try {
                mMediaRouteSelector = new MediaRouteSelector.Builder().addControlCategory(CastMediaControlIntent.categoryForCast(CastService.getApplicationID()))
                        .build();
    ...
    private class MediaRouterCallback extends MediaRouter.Callback {
        ...
        private void addOrUpdateRoute(MediaRouter router, MediaRouter.RouteInfo route) {
        ...
        public void onRouteAdded(MediaRouter router, MediaRouter.RouteInfo route) {
            ...
            removedUUID.remove(CastDevice.getFromBundle(route.getExtras()).getDeviceId());
        ...
        public void onRouteRemoved(final MediaRouter router, final MediaRouter.RouteInfo route) {
            ...
            removedUUID.add(CastDevice.getFromBundle(route.getExtras()).getDeviceId());
            if (removeRoutesTimer == null) {
