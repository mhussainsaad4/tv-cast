...
public class ImageBrowserActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        mTbImagePick.setTitle(mList.get(mCurrentIndex).getName());
        ...
        if (mList.size() > 0) {
            streamFile(mList.get(mCurrentIndex));
            showAds();
        }
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                mTbImagePick.setTitle(mList.get(mCurrentIndex).getName());
                if (prevPos != mCurrentIndex) {
                    prevPos = mCurrentIndex;
                    streamFile(mList.get(mCurrentIndex));
                }
            }
    ...
    private void streamFile(ImageFile file) {
