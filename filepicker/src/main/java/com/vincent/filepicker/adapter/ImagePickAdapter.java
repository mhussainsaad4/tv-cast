...
import static com.vincent.filepicker.Constant.REQUEST_CODE_CAMERA_PERMISSION;
        ...
        if (isNeedCamera && position == 0) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    boolean isGranted = EasyPermissions.hasPermissions(context, "android.permission.CAMERA");
                    if (!isGranted) {
                        EasyPermissions.requestPermissions((Activity) context, context.getString(R.string.vw_camera_permission), Constant.REQUEST_CODE_CAMERA_PERMISSION, "android.permission.CAMERA");
                        return;
                    }
                    cameraCapture();
                }
...
//                    .transition(new DrawableTransitionOptions().crossFade(500))
    ...
    public void cameraCapture() {
        try {
            ...
            contentValues.put(MediaStore.Images.Media.DISPLAY_NAME, "IMG_" + timeStamp + ".jpg");
