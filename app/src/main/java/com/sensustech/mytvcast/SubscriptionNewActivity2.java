...
public class SubscriptionNewActivity2 extends AppCompatActivity implements View.OnClickListener {
    TextView  tvTrial;
//    Button subscriptionButton;
    private String activeSku = "";
    private Boolean fromStart = false;
    private String yearlySku = "weekly_notrial";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppPreferences.getInstance(SubscriptionNewActivity2.this).saveData("isSubscription", true);
    ...
    BroadcastReceiver premiumBroadcast = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (purchaseListingDetails != null && purchaseListingDetails.size() > 0) {
                ...
                if (fromStart) {
                    startActivity(new Intent(SubscriptionNewActivity2.this, MainActivity.class));
                } else {
                    finish();
                }
            }
            ...
            public void run() {
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (purchaseListingDetails.get(activeSku).getProductId().contains("weekly_notrial")) {
...
//                            subscriptionButton.setText("SUBSCRIBE FOR " + formattedPriceWeekly + "/WEEKLY");
                            String txt = "Unlimited access\nfor " + formattedPriceYearly + " per Week";
...
//                showInterAndMoveToNext("ic_close");
           ...
           /* case R.id.subscription_btn:
            ...
            case R.id.trial_btn:
                ...
                AdsManager.getInstance().makeSubscription(SubscriptionNewActivity2.this, activeSku);
                break;
